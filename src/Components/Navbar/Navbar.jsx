                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a href="https://themesberg.com/product/tailwind-css/landing-page"
                            className="text-white cairo bg-green-700 hover:bg-green-500 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0  focus:outline-none ">
                            تسجيل دخول
                        </a>
                        <button
                            onClick={toggleMenu}
